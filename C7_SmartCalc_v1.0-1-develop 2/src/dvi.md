...
- dvi - открытие документации по проекту;

- install - установка калькулятора;

- uninstall - удаление калькулятор;

- gcov_report - создание html-файлы с отчетом по тестам;

- test - запуск тестов;

- rebuild - повторная сборка проекта (калькулятора);

- clang-format - проверка формата *.c и *.h файлов на соответствие clang-format.