...
Suite *s21_test_equal() {
  ...
  tcase_add_test(test_group, equal_1);
  tcase_add_test(test_group, equal_2);
  tcase_add_test(test_group, equal_3);
  tcase_add_test(test_group, equal_4);
  tcase_add_test(test_group, equal_5);
  tcase_add_test(test_group, equal_6);
  tcase_add_test(test_group, equal_7);
  tcase_add_test(test_group, equal_8);
  tcase_add_test(test_group, equal_9);
  tcase_add_test(test_group, equal_10);
  tcase_add_test(test_group, equal_11);
  tcase_add_test(test_group, equal_12);
  tcase_add_test(test_group, equal_13);
  tcase_add_test(test_group, equal_14);
  tcase_add_test(test_group, equal_15);
