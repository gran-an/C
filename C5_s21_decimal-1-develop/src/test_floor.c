...
START_TEST(floor_1) {
  ...
  s21_decimal dest;
  int return_code = s21_floor(src, &dest);
...
START_TEST(floor_2) {
  ...
  s21_decimal dest;
  int return_code = s21_floor(src, &dest);
  ck_assert_uint_eq(dest.bits[0], 11);
  ck_assert_uint_eq(dest.bits[1], 0);
  ck_assert_uint_eq(dest.bits[2], 0);
...
START_TEST(floor_4) {
  ...
  s21_decimal dest;
  int return_code = s21_floor(src, &dest);
  ck_assert_uint_eq(dest.bits[0], 4252028);
...
START_TEST(floor_5) {
  ...
  s21_decimal dest;
  int return_code = s21_floor(src, &dest);
  ck_assert_uint_eq(dest.bits[0], 429496742);
...
START_TEST(floor_9) {
  ...
  s21_decimal dest;
  int return_code = s21_floor(src, &dest);
  ck_assert_uint_eq(dest.bits[0], 562640716);
...
Suite *s21_test_floor() {
  ...
  tcase_add_test(test_group, floor_1);
  tcase_add_test(test_group, floor_2);
  tcase_add_test(test_group, floor_3);
  tcase_add_test(test_group, floor_4);
  tcase_add_test(test_group, floor_5);
  tcase_add_test(test_group, floor_6);
  tcase_add_test(test_group, floor_7);
  tcase_add_test(test_group, floor_8);
  tcase_add_test(test_group, floor_9);
  tcase_add_test(test_group, floor_10);
  tcase_add_test(test_group, floor_11);
