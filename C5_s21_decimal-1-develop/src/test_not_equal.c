...
Suite *s21_test_not_equal() {
  Suite *test_set = suite_create("s21_not_equal");
  TCase *test_group = tcase_create("s21_not_equal_test_group");

  tcase_add_test(test_group, not_equal_1);
  tcase_add_test(test_group, not_equal_2);
  tcase_add_test(test_group, not_equal_3);
  tcase_add_test(test_group, not_equal_4);
  tcase_add_test(test_group, not_equal_5);
  tcase_add_test(test_group, not_equal_6);
  tcase_add_test(test_group, not_equal_7);
  tcase_add_test(test_group, not_equal_8);
  tcase_add_test(test_group, not_equal_9);
  tcase_add_test(test_group, not_equal_10);
  tcase_add_test(test_group, not_equal_11);
  tcase_add_test(test_group, not_equal_12);
  tcase_add_test(test_group, not_equal_13);
  tcase_add_test(test_group, not_equal_14);
  tcase_add_test(test_group, not_equal_15);
