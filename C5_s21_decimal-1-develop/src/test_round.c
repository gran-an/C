...
START_TEST(round_1) {
  ...
  s21_decimal dest;
  int return_code = s21_round(src, &dest);
...
Suite *s21_test_round() {
  ...
  tcase_add_test(test_group, round_1);
  tcase_add_test(test_group, round_2);
  tcase_add_test(test_group, round_3);
  tcase_add_test(test_group, round_4);
  tcase_add_test(test_group, round_5);
  tcase_add_test(test_group, round_6);
  tcase_add_test(test_group, round_7);
  tcase_add_test(test_group, round_8);
  tcase_add_test(test_group, round_9);
  tcase_add_test(test_group, round_10);
  tcase_add_test(test_group, round_11);
