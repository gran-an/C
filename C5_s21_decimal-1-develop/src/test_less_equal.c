...
Suite *s21_test_less_or_equal() {
  Suite *test_set = suite_create("s21_less_or_equal");
  TCase *test_group = tcase_create("s21_less_or_equal_test_group");

  tcase_add_test(test_group, less_or_equal_1);
  tcase_add_test(test_group, less_or_equal_2);
  tcase_add_test(test_group, less_or_equal_3);
  tcase_add_test(test_group, less_or_equal_4);
  tcase_add_test(test_group, less_or_equal_5);
  tcase_add_test(test_group, less_or_equal_6);
  tcase_add_test(test_group, less_or_equal_7);
  tcase_add_test(test_group, less_or_equal_8);
  tcase_add_test(test_group, less_or_equal_9);
  tcase_add_test(test_group, less_or_equal_10);
  tcase_add_test(test_group, less_or_equal_11);
  tcase_add_test(test_group, less_or_equal_12);
  tcase_add_test(test_group, less_or_equal_13);
  tcase_add_test(test_group, less_or_equal_14);
  tcase_add_test(test_group, less_or_equal_15);
  tcase_add_test(test_group, less_or_equal_16);
